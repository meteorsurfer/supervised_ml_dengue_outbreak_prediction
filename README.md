# 🦠 APD Dengue Outbreak Classification Dashboard
...
While the underlying machine learning model may provide accurate or precise classifications of dengue outbreak levels based on historical and environmental data, this tool is **intended solely for educational and personal upskilling purposes**.
It should **not be used as a substitute for professional medical or epidemiological guidance**, nor relied upon for official health or policy decisions.
Always consult and rely on **authorized public health agencies** for verified outbreak information, risk assessment, and response measures.
